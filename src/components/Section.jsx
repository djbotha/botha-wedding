  ...
  return (
    <div className={`relative ${highlight ? 'bg-tuatara-50' : 'bg-tuatara-950'}`} id={id}>
      ...
      <div className="relative flex justify-center">
        {title ? (
          <span
            className={`absolute inline-block -translate-y-1/2 overflow-hidden  px-2 py-2 font-santis text-3xl uppercase text-tuatara-50 drop-shadow-2xl  [text-shadow:_1px_1px_0_rgb(0_0_0_/_80%)]  lg:text-7xl`}
          >
            {title}
          </span>
        ) : null}
